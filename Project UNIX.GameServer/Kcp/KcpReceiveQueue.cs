...
#else
using LinkedListOfQueueItem = System.Collections.Generic.LinkedList<(ProjectUNIX.GameServer.Kcp.KcpBuffer Data, byte Fragment)>;
using LinkedListNodeOfQueueItem = System.Collections.Generic.LinkedListNode<(ProjectUNIX.GameServer.Kcp.KcpBuffer Data, byte Fragment)>;
#endif
